  ...
  User.findOne({ _id: req.user._id }, (err, foundUser) => {
    ...
    if (duplicate) {
      ...
      User.findOneAndUpdate(
        ...
        {
          $push: {
            //push to users cart below object
            cart: {
  ...
  User.findOne(
    ...
    (err, user) => {
      ...
      if (user) {
        ...
        res.json({
          success: false,
          message: "Sorry bad token, generate new one",
        });
      }
    }
  );
